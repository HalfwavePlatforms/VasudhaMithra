...
export default function ReviewQueue({ onSelectRecord }) {
  ...
  return (
    <div style={{ padding: "24px 16px", maxWidth: "1280px", margin: "0 auto", fontFamily: "Inter, system-ui, sans-serif" }}>
      {/* Header Container */}
      <div style={{ backgroundColor: "#FFFFFF", borderRadius: "12px", border: "1px solid #E5E7EB", padding: "24px", marginBottom: "20px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <span style={{ fontSize: "11px", fontWeight: 700, letterSpacing: "0.5px", textTransform: "uppercase", color: "#0B3B60", backgroundColor: "#EFF6FF", padding: "4px 8px", borderRadius: "4px", border: "1px solid #BFDBFE" }}>
              📋 Revenue Revenue Review Backlog
            </span>
            <h2 style={{ fontSize: "20px", fontWeight: 700, color: "#0B3B60", margin: "8px 0 4px 0" }}>
              Land Records Review Queue
            </h2>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "13px" }}>
              <thead>
                <tr style={{ backgroundColor: "#F8FAFC", borderBottom: "2px solid #E2E8F0", color: "#475569", textTransform: "uppercase", fontSize: "11px", letterSpacing: "0.5px" }}>
                  ...
                  <th style={{ padding: "12px 14px" }}>Uploaded At</th>
                  <th style={{ padding: "12px 14px" }}>OCR Confidence</th>
              ...
              <tbody>
                {records.map((r) => {
                  ...
                  let riskStyle = { bg: "#ECFDF5", text: "#059669", border: "#A7F3D0" };
                  if (riskUpper === "MEDIUM") {
                    riskStyle = { bg: "#FFFBEB", text: "#D97706", border: "#FDE68A" };
                  } else if (riskUpper === "HIGH") {
                    riskStyle = { bg: "#FEF2F2", text: "#DC2626", border: "#FECACA" };
                  }
                  ...
                  const confidencePct = typeof r.ocr_confidence === "number"
                  ...
                  return (
                    ...
                    >
                      <td style={{ padding: "12px 14px", fontFamily: "monospace", fontWeight: 700, color: "#0B3B60" }}>
                        {r.record_id}
                      </td>
                      ...
                      <td style={{ padding: "12px 14px" }}>
                        <span
                          style={{
                            ...
                            padding: "3px 8px",
                            borderRadius: "12px",
                            backgroundColor: r.status === "validated" ? "#ECFDF5" : r.status === "rejected" ? "#FEF2F2" : "#FFFBEB",
                            color: r.status === "validated" ? "#059669" : r.status === "rejected" ? "#DC2626" : "#D97706",
                            border: `1px solid ${r.status === "validated" ? "#A7F3D0" : r.status === "rejected" ? "#FECACA" : "#FDE68A"}`,
                            display: "inline-block"
                          }}
                        >
                          {(r.status || "pending_review").toUpperCase().replace("_", " ")}
                        </span>
                      </td>
                      <td style={{ padding: "12px 14px", color: "#6B7280", fontSize: "12px" }}>
                        {formattedDate}
                      </td>
                      <td style={{ padding: "12px 14px", fontWeight: 700, color: "#0B3B60" }}>
                        {confidencePct}
                      </td>
